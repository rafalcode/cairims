...
EXECUTABLES=binodot binind bini2 bini3 b3 b4 b5 b6 b7 b8 b9 b10 b11 b12 six b13 b14 doto smasha2 scalin dric3 td2 rcol hsric2 scalin2 tdisp expti0 expti1 randju0 expti2 jura0 jura0_d rcol2 csvrd rcol rcol3 lou0 lou1 crhmap lou2 lou3 trial0 trial1 trial2 rcol4 ptinsq0 b14a simpsq0 simpsq2 pattapp0 jura1_d
...
# On Sep 22  I came back to do some small mods to jura0 ... and it knocked me utterly for six
# four hours on not getting anywhere. 
# Above all, not understanding it.
# Gross negligence in not writing it up
# jura1 is a result of those mods .. pitiful ... esp cpp vectors
jura1_d: jura1.cpp
	${CPP} ${CFLAGS} -DDBG -o $@ $^ ${SPECLIBS}
