...
bincomp: bincomp.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}
barcentre: barcentre.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}

# using barcentre for sndg sound graph
sndg: sndg.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}
