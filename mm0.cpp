...
int main()
{
    ...
    ImageSurface::create(FORMAT_ARGB32, 600, 400);
    ...
    string filename = "mm0.png";
    surface->write_to_png(filename);
    cout << "Wrote png file \"" << filename << "\"" << endl;
#else
    cout << "You must compile cairo with PNG support for this example t o work." << endl;
#endif
    return 0;
}
