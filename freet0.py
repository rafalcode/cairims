#!/usr/bin/python3
# taken from the cairo site
# deals with issue fo freetypes
# this is Python3 .. you nee dthe cairo dependencies for this
...
def create_cairo_font_face_for_file (filename, faceindex=0, loadoptions=0):
    ...
    return face
#end of func create_cairo_font_face_for_file
